...
[ "$test_data_center" == "1" ] && (
	echo " === RUNNING DATA CENTER TESTS ==="
...
[ "$test_virtual_server" == "1" ] && (
	echo " === RUNNING VIRTUAL SERVER TESTS ==="
	...
	wait_cmd "for data center to be available again" "api get-datacenter-state -dcid $dc_id | grep 'AVAILABLE'"
)
